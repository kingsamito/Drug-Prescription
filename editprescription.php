                    ...
                    <form action="insertpres.php" method="POST">
                        ...
                        <div class="form-row">
                            <div class="input-data">
                                <input type="text" name="patientname" value="<?php echo $patientname ?>" required>
                                <div class="underline"></div>
                                <label for="">Patient Name</label>
                            </div>
                            <div class="input-data">
                                <input type="text" name="patientemail" value="<?php echo $patientemail ?>" required>
                                <div class="underline"></div>
                                <label for="">Patient Email</label>
                            </div>
                            <div class="input-data">
                                <input type="text" name="patientcomplaint" value="<?php echo $patientcomplaint ?>" required>
                                <div class="underline"></div>
                        ...
                        <div class="form-row">
                            <div class="input-data">
                                <input type="text" name="drugname" id="drugname" onkeyup="myFunction()" value="<?php echo $drugname ?>" required>
                                <div class="underline"></div>
                            ...
                            <div class="input-data">
                                <input type="text" name="days" value="<?php echo $days ?>" required>
                                <div class="underline"></div>
                    ...
                    <div class="input-data textarea">
                       ...
                       <br />-->
                        <div class="form-row submit-btn">
                            <div class="input-data">
                                <div class="inner"></div>
                                <input type="submit" name="edit" value="Prescribe">
                            </div>
                        </div>
                    </form>
                </div>
